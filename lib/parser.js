                    ...
                    case "environment":
                        switch (node.value.name) {
                            ...
                            case "itemize":
                                ...
                                break;
                            default:
                                this.update(Object.assign({}, tmp, { children: node.value.arguments.concat(node.value.body) }));
                        }
                        break;
                    case "program":
                        this.update(Object.assign({}, tmp, { type: this.isRoot ? ast_node_types_1.ASTNodeTypes.Document : "Unknown", children: node.value }));
                        break;
                }
            }
        });
