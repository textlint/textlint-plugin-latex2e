...
exports.LaTeX = parsimmon_1.default.createLanguage({
    Block(r) {
        return r.Program.wrap(parsimmon_1.default.string("{"), parsimmon_1.default.string("}"));
    },
    Environment(r) {
        const context = { name: "" };
    ...
    Macro(r) {
        const option = parsimmon_1.default.noneOf("]")
            .many()
            .wrap(parsimmon_1.default.string("["), parsimmon_1.default.string("]"))
            .map((_) => {
            const opt = _.join();
    ...
    Program(r) {
        ...
        return parsimmon_1.default.alt(e, m, r.EmptyLine, r.Text, r.Comment, r.Block)
            .many()
            .node("program");
    },
    Text() {
