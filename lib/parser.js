                ...
                switch (node.name) {
                    ...
                    case "program":
                        ...
                        if (this.parent && this.parent.node.isDocument) {
                            children = [
                                Object.assign({}, tmp, { type: ast_node_types_1.ASTNodeTypes.Paragraph, children: [node.value[0]] })
                            ];
                        ...
                        this.update(Object.assign({}, tmp, { type: this.isRoot ? ast_node_types_1.ASTNodeTypes.Document : ast_node_types_1.ASTNodeTypes.Html, children }));
                        break;
                }
            }
        });
